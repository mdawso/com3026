...
test_suite = [
    ...
    {&PaxosTest.run_simple/3, TestUtil.get_local_config(3), num_runs, "No failures, no concurrent ballots, 3 local procs"},
    {&PaxosTest.run_simple/3, TestUtil.get_dist_config(host, 3), num_runs, "No failures, no concurrent ballots, 3 nodes"},
    {&PaxosTest.run_simple/3, TestUtil.get_local_config(5), num_runs, "No failures, no concurrent ballots, 5 local procs"},

    {&PaxosTest.run_simple_2/3, TestUtil.get_dist_config(host, 3), num_runs, "No failures, 2 concurrent ballots, 3 nodes"},
    {&PaxosTest.run_simple_2/3, TestUtil.get_local_config(3), num_runs, "No failures, 2 concurrent ballots, 3 local procs"},

    {&PaxosTest.run_simple_3/3, TestUtil.get_local_config(3), num_runs, "No failures, 2 concurrent instances, 3 local procs"},

    {&PaxosTest.run_simple_many_1/3, TestUtil.get_dist_config(host, 5), num_runs, "No failures, many concurrent ballots 1, 5 nodes"},
    {&PaxosTest.run_simple_many_1/3, TestUtil.get_local_config(5), num_runs, "No failures, many concurrent ballots 1, 5 local procs"},
   ...
   {&PaxosTest.run_minority_non_leader_crash/3, TestUtil.get_local_config(5), num_runs, "Minority non-leader crashes, no concurrent ballots"},
    ...
    {&PaxosTest.run_leader_crash_simple/3, TestUtil.get_dist_config(host, 5), num_runs, "Leader crashes, no concurrent ballots, 5 nodes"},
    {&PaxosTest.run_leader_crash_simple/3, TestUtil.get_local_config(5), num_runs, "Leader crashes, no concurrent ballots, 5 local procs"},
    ...
    {&PaxosTest.run_leader_crash_complex_2/3, TestUtil.get_local_config(11), num_runs, "Cascading failures of leaders and non-leaders, random delays, 7 local procs"}, 
]
